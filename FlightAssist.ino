...
int Ubatt = 3.4;  
int BattL = 0;
const byte Hmax = 58;                             // max level in cm above the waterline 
int distanceF;
...
void loop () {  
    ...
    distanceF = FilterHight.updateEstimate(distance);  
    ...
    delay(5);                                        // Every 5 miliseconds, do a measurement using the sensor and print the distance in centimeters. 
